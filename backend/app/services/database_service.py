        ...
        for course in courses:
            ...
            if language_key == "kz":
                ...
                details = theory_lines.get("kz") or theory_content.get("sections") or theory_lines.get("ru") or [
                    default_kz_theory,
                    "Келесі қадам - практика",
                    "Тапсырмалар арқылы бекітіңіз",
                ]
            else:
            ...
            if language_key == "kz":
                hint = theory_lines.get("hint", {}).get("kz") or (theory_content.get("takeaways") or [None])[0] or theory_lines.get("hint", {}).get("ru") or "Теорияны оқып, бірден кодтаңыз"
            else:
                hint = (theory_content.get("takeaways") or [None])[0] or theory_lines.get("hint", {}).get("ru") or "Прочитайте теорию и сразу закрепите кодом"

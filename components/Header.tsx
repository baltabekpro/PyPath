    ...
    <header className="flex items-center justify-between px-8 py-6 sticky top-0 bg-py-dark/80 backdrop-blur-md z-10 border-b border-py-accent">
      ...
      <div className="flex items-center gap-8">
        <div className="flex gap-3">
          <button className="size-10 flex items-center justify-center rounded-xl bg-py-accent text-white hover:bg-py-surface hover:text-py-green transition-colors relative group">
            <Bell size={20} />
          ...
          <button className="size-10 flex items-center justify-center rounded-xl bg-py-accent text-white hover:bg-py-surface transition-colors text-yellow-400 shadow-[0_0_15px_rgba(250,204,21,0.1)] hover:shadow-[0_0_20px_rgba(250,204,21,0.2)]">
            <Crown size={20} />
          </button>
        </div>

        {/* User */}
        <div className="flex items-center gap-4 border-l border-py-accent pl-8">
          ...
          <img 
            ...
            alt="Profile" 
            className="size-12 rounded-full border-2 border-py-green/30 object-cover p-0.5 hover:border-py-green transition-colors cursor-pointer"
          />
        </div>
      </div>
    </header>

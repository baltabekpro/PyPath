    ...
    <div className="p-8 max-w-6xl mx-auto space-y-8 animate-fade-in">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-4 space-y-6">
              {/* Profile Card */}
              <div className="bg-py-surface border border-py-accent rounded-2xl p-6 flex items-center gap-4">
              ...
              <div className="bg-py-surface border border-py-accent rounded-2xl p-6">
                   ...
                   <div className="space-y-6">
                        <div className="flex items-center justify-between pb-6 border-b border-white/5">
                            ...
                            <div className="w-12 h-6 bg-py-green rounded-full relative cursor-pointer shadow-[0_0_10px_rgba(13,242,89,0.3)]">
                        ...
                        <div className="flex items-center justify-between pb-6 border-b border-white/5">
                            ...
                            <div className="w-12 h-6 bg-[#1f2e25] rounded-full relative cursor-pointer border border-white/10">

    ...
    <div className="p-8 max-w-6xl mx-auto space-y-12 animate-fade-in pb-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-end mb-12 min-h-[360px]">
        ...
        <div className="order-2 md:order-1 bg-[#0c120e] border border-white/5 rounded-3xl p-6 flex flex-col items-center relative h-[300px] justify-end group hover:border-py-accent transition-colors shadow-lg">
           <div className="absolute top-8 size-24 rounded-full border-4 border-gray-500 p-1 bg-[#0c120e]">
             <img src={MOCK_LEADERS[1].avatar} className="w-full h-full rounded-full object-cover" alt="Rank 2" />
             <div className="absolute -bottom-3 left-1/2 -translate-x-1/2 bg-gray-500 text-py-dark font-black size-7 rounded-full flex items-center justify-center text-sm border-4 border-[#0c120e]">2</div>
           </div>
        ...
        {/* 1st Place - Center */}
        <div className="order-1 md:order-2 bg-gradient-to-b from-[#1a2e21] to-[#0a0f0b] border border-yellow-500/20 rounded-3xl p-8 flex flex-col items-center relative h-[380px] justify-end shadow-[0_0_50px_rgba(234,179,8,0.05)] z-10 transform md:-translate-y-4 overflow-visible">
           {/* Crown moved up */}
           <div className="absolute -top-10">
             <Crown size={64} className="text-yellow-400 fill-yellow-400 drop-shadow-[0_0_25px_rgba(250,204,21,0.6)]" />
           </div>
           ...
           <div className="absolute top-12 size-36 rounded-full border-4 border-yellow-400 p-1 shadow-[0_0_40px_rgba(250,204,21,0.15)] bg-[#0a0f0b]">
             ...
             <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 bg-yellow-400 text-black font-black size-10 rounded-full flex items-center justify-center border-4 border-[#1a2e21] text-lg">1</div>
           </div>
           ...
           <div className="bg-[#111c15] rounded-xl w-full flex items-center justify-between p-4 border border-white/10 shadow-inner">

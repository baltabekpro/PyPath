...
const KZ_TEXT_OVERRIDES = {
    ...
    achievements: {
        ...
        emptyTitle: 'Жетістіктер әзірге қолжетімсіз',
        emptyDescription: 'Деректер пайда болғанда, барлық марапаттар осы жерде көрсетіледі.',
        shareTitle: 'PyPath жетістігі',
        pointsLabel: 'ҰПАЙ',
        rareLabel: 'СИРЕК',
        legendaryLabel: 'АҢЫЗ',
        share: 'Бөлісу',
    ...
    leaderboard: {
        ...
        emptyTitle: 'Рейтинг әзірге бос',
        emptyDescription: 'Ойыншылар нәтижелері пайда болғанда, лидерлер кестесі осында көрсетіледі.',
        scopes: {
            global: 'Әлем',
        },
        periods: {
